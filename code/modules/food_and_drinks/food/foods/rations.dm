...
/obj/item/food/snacks/rations/liquidfood
	...
	tastes = list("chemicals" = 2, "artificial vanilla, struggling to reach your tastebuds" = 2, "mush" = 2, "sludge" = 1, "merciful blandness" = 1)
...
/obj/item/food/snacks/rations/mre/pork
	...
	tastes = list("pork" = 3, "BBQ sauce" = 3, "a hint of salt" = 2)
...
/obj/item/food/snacks/rations/mre/pizza
	...
	tastes = list("cheese" = 1, "cardboard" = 1, "bread" = 1)
...
/obj/item/food/snacks/rations/mre/sushi
	...
	tastes = list("fish" = 1, "egg" = 1, "seaweed" = 1)
...
/obj/item/food/snacks/rations/mre/spaghetti
	...
	tastes = list("spaghetti" = 1, "tomato" = 1, "herbs" = 1, "salt")
...
/obj/item/food/snacks/rations/mre/fettuccini
	...
	tastes = list("pasta" = 2, "spinach" = 2, "cream sauce" = 2, "herbs" = 1, "salt" = 1)
...
/obj/item/food/snacks/rations/mre/vomlette
	...
	tastes = list("very artifical cheese" = 1, "chemicals" = 1 , "artificial preservatives" = 1, "something resembling a vegetable" = 1)
...
/obj/item/food/snacks/rations/mre/cheese_crackers
	...
	tastes = list("cracker" = 1, "artificial cheese" = 1, "salt" = 1)
...
/obj/item/food/snacks/rations/mre/onigiri
	...
	tastes = list("rice" = 2, "sweetness" = 2, "seaweed" = 1)
...
/obj/item/food/snacks/rations/mre/pretzel_nugget
	...
	tastes = list("mustard" = 3, "tangy sweetness" = 2, "salt" = 2)
...
/obj/item/food/snacks/rations/mre/peanut_crackers
	...
	tastes = list("cracker" = 2, "peanut butter" = 3, "salt" = 1)
...
/obj/item/food/snacks/rations/mre/fighting_fuel	// Powerful ration bar, can also be found on its own.
	...
	tastes = list("chocolate" = 3, "fruits and nuts" = 2, "<b>FREEDOM</b>" = 1)
...
/obj/item/food/snacks/rations/mre/bun
	...
	tastes = list("an overwhelming sweetness" = 2, "cinnamon" = 2, "cake" = 3, "bread" = 1)
...
/obj/item/food/snacks/rations/mre/brownie
	...
	tastes = list("chocolate" = 3, "sweetness" = 1)
...
/obj/item/food/snacks/rations/mre/flan
	...
	tastes = list("honey" = 3, "caramel" = 2, "sweetness" = 1)
...
/obj/item/food/snacks/rations/mre/spiced_apple
	...
	tastes = list("cinnamon" = 2, "applie" = 2, "spices" = 1)
...
/obj/item/food/snacks/rations/mre/smores
	...
	tastes = list("chocolate" = 1, "marshmallow" = 1, "sweet sticky granola" = 1)
...
/obj/item/food/snacks/rations/mre/pancake
	...
	tastes = list("maple syrup" = 3, "butter" = 2, "pancake" = 1)
...
/obj/item/storage/box/mre
	...
	desc = "A compact SolGov-produced field ration designed to feed a soldier in active combat. Contains self-heating food packets that require no prior preperation. This one contains the [menu_option] menu. Meets all of the legal and technical requirements to be considered real food!"
	storage_slots = 8
	can_hold = list(
		/obj/item/food/snacks/rations,
	...
	var/menu_option = pick("Chicken & Cavatelli", "BBQ Pork & Rice", "Pepperoni Pizza & Cheese-Filled Crackers", "Sushi & Rice Onigiri", "Spaghetti & Meatballs", "Creamy Spinach Fettuccini", "Cheese & Veggie Omlette")
...
/obj/item/storage/box/mre/proc/get_menu_option()
	var/static/list/menu_item_list = list(
		...
		var/menu_items = menu_item_list[menu_option]
	)