...
/obj/item/food/snacks/rations/nutrient_prism/attack(mob/M, mob/user)
	...
	if(!do_after(user, delay = 5 SECONDS, target = user))	// It's VERY VERY chewy. A few months of service and you shall have the most strong, chiseled jaw ever. Like the soldiers on propagana posters have.
